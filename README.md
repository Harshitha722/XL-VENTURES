...
- **State Management:** Zustand (client-side state management, e.g., `useDecisionStore`)
...
- **Data Validation:** Pydantic (strict typing and schema validation)
- **AI Agent Orchestration:** PydanticAI (LLM-driven agent pipelines)
